...
class ProvinceDetailService {
  ...
  static Future<List<String>> getProvincesWithDetailedData() async {
    ...
    return ['hai_phong', 'ha_noi', 'quang_ninh', 'hue', 'dien_bien', 'cao_bang', 'lai_chau', 'son_la', 'lang_son', 'nghe_an', 'thanh_hoa', 'ha_tinh', 'phu_tho', 'tuyen_quang', 'bac_ninh', 'ninh_binh', 'hung_yen', 'quang_tri', 'quang_ngai', 'lam_dong', 'da_nang', 'khanh_hoa']; // Thêm các tỉnh khác khi có file JSON
  }
} 