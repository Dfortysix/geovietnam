...
class ProvinceDetailService {
  ...
  static Future<List<String>> getProvincesWithDetailedData() async {
    ...
    return ['hai_phong', 'ha_noi', 'quang_ninh', 'hue', 'dien_bien', 'cao_bang', 'lai_chau', 'son_la', 'lang_son', 'nghe_an', 'thanh_hoa', 'ha_tinh', 'phu_tho']; // Thêm các tỉnh khác khi có file JSON
  }
} 